...
class TravelCalculatePremiumControllerTest {
    ...
    private void runTestCase(String testCase) throws Exception {
        String requestPath = "/rest/" + testCase + "/request.json";
        String expectedResponsePath = "/rest/" + testCase + "/response.json";
    ...
    private void performAndCheck(String requestPath, String expectedResponsePath) throws Exception {
        ...
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post("/insurance/travel/api/")
                        .content(requestJson)
